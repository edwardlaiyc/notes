...
![](images/intermediate-value-theorem-01.webp)

If f is not continuous, IVT may not hold:

![](images/intermediate-value-theorem-02.webp)

If f is not continuous on closed interval, IVT may not hold:

![](images/intermediate-value-theorem-03.webp)
...
![](images/min-max-theorem-01.webp)
