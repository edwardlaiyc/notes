...
![](images/proof-by-contradiction-01.png)

## Proof by contrapositive

$$\text{If }x \text{ and } y \text{ are integers such that } 5 \nmid xy, \text{ then } 5 \nmid x \text{ and } 5 \nmid y.$$

![](images/proof-by-contrapositive-01.png)
